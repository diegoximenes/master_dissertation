...
to different \glspl*{ip}.
Therefore, considering the lack of a private \gls*{ip} to name mapping, the CMTSs
were also discarded.
...
by header's fields of \gls*{ip} packets. For example, a
...
to the end-user, since losses of \gls*{tcp}'s ACKs can influence the measurement
performance.
...
lack of information about the topology above the \gls*{ip} layer, the first two cases
can't be
