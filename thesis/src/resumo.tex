Com o objetivo de melhor entender o desempenho dos seus servi\c{c}os de banda
larga, um grande Tier-3 ISP brasileiro, em parceria com a UFRJ e a startup TGR,
estabeleceram um projeto para, atrav\'es de medidas fim-a-fim de QoS,
avaliar o desempenho do servi\c{c}o prestado em um subconjunto dos seus
clientes.
...
interpretado como uma mudan\c{c}a no comportamento de um equipamento, que por sua
vez afeta a qualidade de servi\c{c}o percebido pelos usu\'arios,
...
que permite explorar mudan\c{c}as estat\'isticas nas s\'eries temporais de QoS de
...
A fim de aumentar o
desempenho do sistema proposto, esta disserta\c{c}\~ao tamb\'em indica poss\'iveis
melhoras na atual metodologia de medi\c{c}\~ao.
