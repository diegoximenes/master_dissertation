...
\begin{figure}[H]
    ...
    \makebox[\textwidth][c]{%
        \begin{subfigure}[b]{0.6\textwidth}
            \includegraphics[width=\textwidth]{./figures/change_point_detection/preprocessing/serverAMRDTCPEV01_mac64:66:B3:4F:EC:6C_dtstart2016-07-01_dtend2016-07-11.png}
        \end{subfigure}
        \begin{subfigure}[b]{0.6\textwidth}
            \includegraphics[width=\textwidth]{./figures/change_point_detection/preprocessing/serverAMRDTCPEV01_mac64:66:B3:4F:FD:B6_dtstart2016-07-01_dtend2016-07-11.png}
        \end{subfigure}%
    }
    \caption{Median filter. $w=13$.}\label{fig:median_filter}
\end{figure}
...
It was empirically verified that, in general, the choice of log likelihoods
as the cost function can turn the method very sensible to outliers.
